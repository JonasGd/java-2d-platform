...
public class Gizmo extends Component{
    ...
    private Vector2f xAxisOffset = new Vector2f(52.0f,-7.0f);
    private Vector2f yAxisOffset = new Vector2f(9.0f,52.0f);

    private int gizmoWidth = 16;
    private int gizmoHeight = 24;
